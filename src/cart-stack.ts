...
export class CartStack {
  ...
  update() {
    const builtIns = ['ouroboros.nes', 'planter.nes', 'bare-metal-e.nes', 'bare-metal-br.nes', 'raddio.nes', 'controll.nes', 'retropia.nes', 'retropia-ptbr.nes', 'blobland.nes', 'lowas.nes', 'happy.nes', 'macaco.nes'];
